...
export default function setupEditors() {
    ...
    const jsonResposneBody = document.querySelector('[data-json-response-body]');
    ...
    function updateRequestEditor(value) {
    ...
    return { requestEditor, updateResponseEditor, updateRequestEditor }
}